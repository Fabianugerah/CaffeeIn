...
export default function AlertDialog({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-fade-in">
      ...
      {/* Dialog */}
      <div className="relative bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl max-w-sm w-full animate-scale-in border border-neutral-200 dark:border-neutral-800 overflow-hidden">
        {/* Content */}
        <div className="p-6">
